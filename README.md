...
- Select a friendly symbol; right-click water to order movement. Shift appends waypoints. A ship will not take an order onto land, and a leg that crosses a coast is drawn in red from the beach onward. Wheel zooms; middle/right drag pans. Hover over any symbol — or over land — for a quick card.
